...
@section('content')
  ...
  <form action="/services/{{$service->id}}" autocomplete="off" method="POST">
	        ...
	        <div class="app-card-body px-4 w-100">
	        	...
	        	@unless(count($pianos) == 0)
								...
								<div class="col-9">
									<select class="form-select" id="piano" name="piano_id">
										...
										@foreach($pianos as $piano)
											<option value="{{$piano->id}}" {{$service->piano_id == $piano->id ? 'selected' : ''}}>
								...
								<div class="col-9">
									<select class="form-select" id="type_id" name="type_id">
										...
										@foreach($types as $type)
											<option value="{{$type->id}}" {{$service->type_id == $type->id ? 'selected' : ''}}>
												{{$type->type}}
											</option>
										@endforeach
									</select>
							...
							<div class="row mb-3">
								...
								<div class="col-9">
									...
									<div class="input-group mb-3 w-25">
										...
										<input type="number" min="0" step=".01" class="form-control" id="price" name="price" value="{{$service->price}}" value="0.00">
									</div>
							...
							<div class="row mb-3">
								...
								<div class="col-9">
									<input type="text" class="form-control" id="technician" name="technician" value="{{$service->technician}}">		
							...
							<div class="row mb-3">
								...
								<div class="col-9">
									<textarea class="form-control" id="notes" rows="10" name="notes" style="height:100px;">{{$service->notes}}</textarea>
		        ...
		        <div class="app-card-footer p-4 mt-auto">
		          <button type="submit" class="btn app-btn-primary">Update Service</button>
		        </div>
		        <!--//app-card-footer-->
