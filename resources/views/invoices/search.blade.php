	  ...
	  <div class="col-auto">
	    <div class="page-utilities">
	      <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
	        <div class="col-auto">
	          <form class="table-search-form row gx-1 align-items-center" action="/invoices/search" method="POST">
	          	@csrf
	            <div class="col-auto">
	              <input type="text" id="search-invoices" name="search" class="form-control search-invoices" placeholder="Search" value="{{isset($search) ? $search : ''}}">
	            </div>
	            <div class="col-auto">
