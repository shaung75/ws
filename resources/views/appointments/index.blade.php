      ...
      <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
        ...
        <div class="app-card-header p-3 border-bottom-0">
          <div class="row align-items-center gx-3">
            ...
            <!--//col-->
            <div class="col-auto">
              <h4 class="app-card-title">Carried Over</h4>
            </div>
            <!--//col-->
          </div>
          <!--//row-->
                    ...
                    <td class="cell">
                      <a href="/clients/{{$carry->client_id}}">
                        @if($carry->business_name)
                          {{$carry->business_name}}
                        @else
                          {{$carry->first_name}} {{$carry->surname}}
                        @endif
                      </a></td>
                    <td class="cell">{{$carry->town}}</td>
                    <td class="cell text-end"><a href="/appointments/create/{{$carry->client_id}}">Book in</a></td>
                  </tr>
                @endforeach                                   
